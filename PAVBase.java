...
public class PAVBase {
    ...
    public static class ResultTuple {
        ...
        public ResultTuple(String method, String prgpoint, String varname, String lowerval, String upperval) {
            this.m = method;
            this.p = prgpoint;
            this.v = varname;
            this.l = lowerval;
        ...
        public ResultTuple(String method, String prgpoint, String callMethod, String varname, String lowerval,
                String upperval) {
            this.m = method;
            this.p = prgpoint;
            this.v = varname;
        ...
        public String toString() {
            return this.m + "." + this.p + "." + this.v + "." + this.l + "." + this.u + "." + this.cM;
        }

        @Override
        public boolean equals(Object o) {

            ResultTuple vC = (ResultTuple) o;
            return (this.m.toString().equals(vC.toString()));
        }
    }

    protected static String fmtOutputLine(ResultTuple tup, String prefix) {
        String line = tup.m + ": " + tup.p + ":  " + tup.cM + " => " + tup.v + ": " + "[" + tup.l + ", " + tup.u + "]";
        return (prefix + line);
    }
